...
Margin: native model gives BTC 80k/40 + SOL 80k/20 = 6k IM; an 1,100-SOL increase is fail-closed pre-submit against native free account balance. Reservations retain parent IM through partial fill until confirmed cancel. Public Bybit BTC tier module consumes explicit mark events (never quote-mid); unchanged quotes with mark 75k→80k cross 300k tier boundary and update native MarginAccount to IM 3,200/MM 1,090 after deduction.
