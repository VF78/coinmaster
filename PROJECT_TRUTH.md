...
Последнее обновление: 2026-02-13 02:00 Europe/Madrid
...
### Вход Short
- После команды `BTC short` мониторим 5m и 15m без ожидания отдельного «заброса».
...
### Вход Long
- Зеркально Short после команды `BTC long` (локальный минимум за 30 свечей + бычье поглощение).
